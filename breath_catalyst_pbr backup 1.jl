...
using Optim, DataFrames, CSV, ColorSchemes, PlutoUI, CairoMakie, DiffEqOperators, ModelingToolkit, DifferentialEquations, DomainSets, MethodOfLines
...
gen_video(plume_model, framerate=3, Δx₁=Δx, Δt=Δt)
...
begin
	Vspan= (1.0, 5)
	prob = ODEProblem(solve!, [0.0, T], Vspan, [Fₐ₀, 0, 0])
	sol = solve(prob)
	rename!(DataFrame(sol)[:, [1, 2]], "timestamp" => :Weight, "value1" => :X)
end
...
git-tree-sha1 = "6d878b416680b7eaf5fae71990028c982e7c8b38"
...
git-tree-sha1 = "f26e88ed0cef2f4d8606570bc02fc99ac17c3030"
